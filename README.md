...
```
NEXT_PUBLIC_SITE_URL=https://www.getlitmus.xyz
...
ASSESSMENT_INBOX=                        # inbox for new paid-assessment requests
ASSESSMENT_ADMIN_EMAILS=                 # comma-separated Clerk email allowlist for /ops/assessments
CRON_SECRET=
TELEGRAM_BOT_TOKEN=
